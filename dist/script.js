...
/* harmony import */ var _modules_slides__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/slides */ "./src/js/modules/slides.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_slides__WEBPACK_IMPORTED_MODULE_2__["default"])('.feedback-slider-item', '', '.main-prev-btn', '.main-next-btn');
  Object(_modules_slides__WEBPACK_IMPORTED_MODULE_2__["default"])('.main-slider-item', 'vertical');
...
var forms = function forms() {
  ...
  uploads.forEach(function (item) {
    ...
    item.addEventListener('input', function () {
      ...
      var name = arr[0].substring(0, 6) + dots + arr[1].substring(0, 6);
...
var mask = function mask(selector) {
  ...
  function createMask(event) {
    ...
    var num = val.substring(0, 1);

    if (event.type === 'input') {
      if (num !== '7') {
        var newStr = val.replace(num, '');
        val = newStr;
      }
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        windows.forEach(function (item) {
          item.style.display = 'none'; // item.classList.remove('fadeOut')
    ...
    close.addEventListener('click', function () {
      windows.forEach(function (item) {
        item.style.display = 'none'; // item.classList.remove('fadeIn')
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResource"])('http://localhost:3000/styles').then(function (res) {
      ...
      errorMess.style.width = '300px';
      errorMess.style.height = '300px';
      errorMess.textContent = 'Ошибка';
      wrapper.appendChild(errorMess);
    });
    this.remove();
  });
...
var slides = function slides(sliders, direction, prev, next) {
  var slideIndex = 1,
      paused = false;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Could't fetch ".concat(url, ", status ").concat(res.status));
